...
export const resources = {
  ru: {
    translation: {
      ...
      intro: '<span class="text-slate-200">Breadboard Maketka</span> — модульная система для стандартных макетных плат  с единой крепёжной сеткой <span class="text-neon">15&nbsp;мм</span>. Здесь лежат STL-файлы модулей для 3D-печати: три базовых размера, которые можно печатать по отдельности и наращивать друг с другом  боковушками и разными расширениями.',
      ...
      small_desc: 'S-модуль <span class="text-dim">60 × 45 мм</span>. Базовый блок, печатается одной деталью, без шин.',

      medium_title: 'Средний',
      medium_desc: 'M-модуль <span class="text-dim">90 × 45 мм</span> <span class="text-neon">+ боковушка</span> <span class="text-mag">(шина 90 × 15 мм, печатать ×2)</span> по бокам.',

      large_title: 'Большой',
      large_desc: 'L-модуль <span class="text-dim">180 × 45 мм</span> <span class="text-neon">+ боковушка</span> <span class="text-mag">(шина 180 × 15 мм, печатать ×2)</span> по бокам.',
      ...
      dop_ugl_ss_title: 'Угловой переходник SS',
      ...
      br_g_i60:  'прямые I · ширина 60 мм',
      br_g_i90:  'прямые I · ширина 90 мм',
      br_g_i180: 'прямые I · ширина 180 мм',
  ...
  en: {
    translation: {
      ...
      intro: '<span class="text-slate-200">Breadboard Maketka</span> is a modular system for standard breadboards with a single <span class="text-neon">15&nbsp;mm</span> mounting grid. Here are the module STL files for 3D printing: three base sizes that can be printed separately and extended with side strips and different extras.',
      ...
      small_title: 'Small',
      small_desc: 'S-module <span class="text-dim">60 × 45 mm</span>. Base block, printed as a single part, no bus strips.',

      medium_title: 'Medium',
      medium_desc: 'M-module <span class="text-dim">90 × 45 mm</span> <span class="text-neon">+ side strip</span> <span class="text-mag">(bus 90 × 15 mm, print ×2)</span> on the sides.',

      large_title: 'Large',
      large_desc: 'L-module <span class="text-dim">180 × 45 mm</span> <span class="text-neon">+ side strip</span> <span class="text-mag">(bus 180 × 15 mm, print ×2)</span> on the sides.',
      ...
      dop_ugl_ss_title: 'Angle adapter SS',
      ...
      br_g_i60:  'straight I · 60 mm wide',
      br_g_i90:  'straight I · 90 mm wide',
      br_g_i180: 'straight I · 180 mm wide',
